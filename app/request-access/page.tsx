            ...
            <nav className="relative z-50 border-b border-white/5 bg-black/20 backdrop-blur-md">
                <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                    <Link href="/" className="flex items-center space-x-2 group">
                        ...
                        <span className="text-sm font-mono text-gray-400 group-hover:text-white transition-colors">Back</span>
                    </Link>
                    <Image
            ...
            <main className="relative z-10 max-w-6xl mx-auto px-6 py-20 lg:py-32 grid grid-cols-1 lg:grid-cols-2 gap-20">
                ...
                <div className="flex flex-col justify-center">
                    <div className="inline-flex items-center space-x-2 mb-6 px-3 py-1 border border-blue-500/30 bg-blue-900/10 rounded-full w-fit">
                        ...
                        <span className="text-[10px] font-mono text-blue-400 tracking-widest uppercase">Encryption Standard: AES-256</span>
                    </div>
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tighter mb-8 bg-clip-text text-transparent bg-gradient-to-b from-white to-gray-500 leading-tight">
                        Secure your <br />Asset Intelligence.
                    </h1>

                    <p className="text-lg text-gray-400 mb-12 max-w-md leading-relaxed">
                        Join the vetted network of high-security organizations using EstateVision to predict and mitigate physical world risks.
                    </p>

                    <div className="space-y-6">
                        {[
                            { icon: Shield, title: "Identity Verification", desc: "All requests are manually vetted for security clearance." },
                            { icon: Zap, title: "Accelerated Deployment", desc: "Configuration within 48 hours for approved entities." },
                            { icon: Terminal, title: "Direct API Access", desc: "Integration protocols for sovereign data systems." }
                        ].map((item, i) => (
                    ...
                    <AnimatePresence mode="wait">
                        {status !== 'success' ? (
                            ...
                            >
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-[10px] font-mono text-gray-500 uppercase tracking-widest ml-1">Corporate Email</label>
                                            <input
                                                required
                                                type="email"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-mono text-gray-500 uppercase tracking-widest ml-1">Organization / Enterprise</label>
                                        <input
                                            required
                                            type="text"
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-mono text-gray-500 uppercase tracking-widest ml-1">Phone Number</label>
                                    ...
                                    <div className="space-y-2">
                                        <label className="text-[10px] font-mono text-gray-500 uppercase tracking-widest ml-1">Primary Role (Buyer Persona)</label>
                                        <div className="relative">
                                            <select
                                                required
                                            ...
                                            >
                                                <option value="" disabled className="bg-[#0a0a0a]">Select your mandate</option>
                                                <option value="enterprise" className="bg-[#0a0a0a]">Enterprise Client</option>
                                                <option value="asset_manager" className="bg-[#0a0a0a]">Asset Manager</option>
                                                <option value="security_manager" className="bg-[#0a0a0a]">Security Manager</option>
                                            </select>
                                    ...
                                    <div className="flex items-center space-x-3 group cursor-pointer" onClick={() => setFormData({ ...formData, acceptedTerms: !formData.acceptedTerms })}>
                                        ...
                                        <span className="text-[10px] font-mono text-gray-400 uppercase tracking-widest select-none">I have read and accept the terms and conditions</span>
                                    </div>
                                    ...
                                    <p className="text-[9px] text-gray-600 font-mono text-center tracking-widest leading-relaxed">
                                        BY SUBMITTING, YOU CONSENT TO OUR DATA PRIVACY PROTOCOLS. <br />
                                        SYSTEMS LOGGED // IP TRACKED FOR AUDIT PURPOSES.
                                    </p>
                                </form>
                            </motion.div>
                        ) : (
                            ...
                            >
                                ...
                                <h2 className="text-3xl font-bold text-white mb-4">Application Registered</h2>
                                <p className="text-gray-400 mb-8 max-w-sm">
                                    Transmission received. Our intelligence team will vet your credentials within 24-48 hours.
                                </p>
