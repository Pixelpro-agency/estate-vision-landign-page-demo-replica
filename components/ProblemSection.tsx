        ...
        <section className="py-32 bg-[#02040A] border-t border-white/5 relative">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid md:grid-cols-3 gap-12 relative">
                    ...
                    {/* 1. Enterprise: Siloed Intelligence */}
                    <motion.div
                    ...
                    >
                        ...
                        <div className="text-center px-4">
                            <h3 className="text-xl font-bold text-white mb-4">Siloed Intelligence</h3>
                            <p className="text-gray-400 text-sm leading-relaxed">
                                Enterprise data is trapped in disconnected legacy systems. Leadership lacks the cohesive visibility required to optimize portfolio performance and mitigate global risks.
                            </p>
                        </div>
                    </motion.div>

                    {/* 2. Asset Manager: Operational Blind Spots */}
                    <motion.div
                        initial={{ opacity: 0, y: 30 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, margin: "-50px" }}
                    ...
                    >
                        ...
                        <div className="text-center px-4">
                            <h3 className="text-xl font-bold text-white mb-4">Operational Blind Spots</h3>
                            <p className="text-gray-400 text-sm leading-relaxed">
                                Infrastructure is degrading faster than tracked. Reliance on scheduled maintenance misses real-time signs of asset drift, leading to costly, preventable downtime.
                            </p>
                        </div>
                    </motion.div>

                    {/* 3. Security Manager: Static Defense */}
                    <motion.div
                        initial={{ opacity: 0, y: 30 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, margin: "-50px" }}
                    ...
                    >
                        ...
                        <div className="text-center px-4">
                            <h3 className="text-xl font-bold text-white mb-4">Static Defense</h3>
                            <p className="text-gray-400 text-sm leading-relaxed">
                                Traditional security is reactive. Relying on cameras and guards alone leaves facilities exposed to sophisticated, predictive threats that bypass standard perimeters.
                            </p>
                        </div>
                    </motion.div>
