            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 h-full pt-20 flex items-center pointer-events-none">
                ...
                <div className="w-full lg:w-1/2 pointer-events-auto pr-0 lg:pr-12 py-12 lg:py-0">
                    ...
                    >
                        ...
                        {/* Secondary Button */}
                        <button className="h-14 w-full sm:w-auto min-w-[200px] group border border-white/20 hover:border-white/40 text-gray-300 hover:text-white font-mono uppercase text-sm tracking-wider transition-all backdrop-blur-sm bg-black/20 cursor-pointer flex items-center justify-center text-center">
                            Schedule Briefing
                        </button>
                    </motion.div>
                    ...
                    >
                        <div className="flex flex-col items-center justify-center text-center">
                            ...
                            <div className="text-[10px] text-gray-500 uppercase tracking-widest font-semibold">Countries Monitored</div>
                        </div>
                        <div className="flex flex-col items-center justify-center text-center border-t sm:border-t-0 sm:border-l border-white/5 pt-4 sm:pt-0 sm:pl-8">
                            ...
                            <div className="text-[10px] text-gray-500 uppercase tracking-widest font-semibold">Assets Tracked</div>
                        </div>
                        <div className="flex flex-col items-center justify-center text-center border-t sm:border-t-0 sm:border-l border-white/5 pt-4 sm:pt-0 sm:pl-8">
                            <div className="text-3xl font-mono font-bold text-teal-400 mb-2">
                                <Counter value={99.9} decimals={1} suffix="%" />
                            </div>
                            <div className="text-[10px] text-gray-500 uppercase tracking-widest font-semibold">Uptime Guarantee</div>
                        </div>
                    </motion.div>
                </div>
